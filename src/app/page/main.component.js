        ...
        function goNextAsync() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, self.service.isValid(self.form)];
                        case 1:
                            answer = _a.sent();
                            ...
                            return [3 /*break*/, 4];
                        case 2:
                            self.form.value.forEach(function (key, value) {
                                return session_1.Session.set(key, value);
                            });
    ...
    MainComponent.prototype.clear = function () {
        ...
        this.router.navigateByUrl('/')
            .then(function (success) {
                return console.log('Go to first page');
            })
            .catch(function (err) {
